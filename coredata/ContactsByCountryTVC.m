...
@interface ContactsByCountryTVC () <NSFetchedResultsControllerDelegate>
@property (nonatomic, strong) NSFetchedResultsController *fetchedResultsController;
@end

@implementation ContactsByCountryTVC
...
- (NSFetchedResultsController *)fetchedResultsController {
    if (!_fetchedResultsController) {
        NSArray *terms = @[[NSSortDescriptor sortDescriptorWithKey:@"name"
                                                         ascending:YES
